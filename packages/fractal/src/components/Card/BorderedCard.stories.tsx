...
export const BasicCards: Story = {
  ...
  render: ({ children }) => (
    ...
    >
      <Card color="blue" elevation="1">
        {children}
      </Card>
      <Card color="green" elevation="1">
        {children}
      </Card>
      <Card color="pink" elevation="1">
        {children}
      </Card>
      <Card color="purple" elevation="1">
        {children}
      </Card>
      <Card color="white" elevation="1">
        {children}
      </Card>
      <Card color="yellow" elevation="1">
        {children}
      </Card>
    </div>
  ),
