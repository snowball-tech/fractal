...
export const BasicCards: Story = {
  ...
  render: ({ children }) => (
    ...
    >
      <Card color="blue" elevation="2">
        {children}
      </Card>
      <Card color="green" elevation="2">
        {children}
      </Card>
      <Card color="pink" elevation="2">
        {children}
      </Card>
      <Card color="purple" elevation="2">
        {children}
      </Card>
      <Card color="white" elevation="2">
        {children}
      </Card>
      <Card color="yellow" elevation="2">
        {children}
      </Card>
    </div>
  ),
